...
def pregunta_02():
    ...
    print(df.life.corr(df.fertility, method='pearson', min_periods=1).round(4))
    ...
    print(df.GDP.corr(df.life, method='pearson', min_periods=1).round(4))
...
def pregunta_03():
    ...
    # print(prediction_space.shape, X_fertility.shape, y_life.shape)
